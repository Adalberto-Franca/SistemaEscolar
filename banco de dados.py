...
# Classe Aluno
class Aluno:
    def __init__(self, nome, data_nascimento, turma_id, cpf, cep, telefone):
        self.nome = nome
    ...
    def salvar(self):
        query = "INSERT INTO Alunos (Nome, DataNascimento, TurmaID, CPF, CEP, Telefone) VALUES (%s, %s, %s,%s,%s,%s)"
        values = (self.nome, self.data_nascimento, self.turma_id, self.cpf, self.cep, self.telefone )
    ...
    def listar():
        ...
        for aluno in result:
            print(f"ID: {aluno[0]}, Nome: {aluno[1]}, Data de Nascimento: {aluno[2]}, Turma ID: {aluno[3]}, CPF: {aluno[4]}, CEP: {aluno[5]}, Telefone: {aluno[6]} ")
...
class Professor:
    def __init__(self, nome, cpf, cep, telefone):
        self.nome = nome
        self.cpf = cpf
        self.cep = cep
        self.telefone = telefone
    ...
    def salvar(self):
        query = "INSERT INTO Professores (Nome, CPF, CEP, Telefone) VALUES (%s,%s,%s,%s)"
        values = (self.nome, self.cpf, self.cep, self.telefone)
        cursor.execute(query, values)
        db.commit()
    ...
    def listar():
        ...
        for professor in result:
            print(f"ID: {professor[0]}, Nome: {professor[1]}, CPF: {professor[2]}, CEP: {professor[3]}, Telefone: {professor[4]}")
...
if __name__ == "__main__":
    while True:
        ...
        if opcao == "1":
            ...
            aluno = Aluno(nome, data_nascimento, turma_id, cpf, cep, telefone)
            aluno.salvar()
            ...
            cep = str(input("CEP: "))
            telefone = int(input("Telefone: "))
            professor = Professor(nome, cpf, cep, telefone)
            professor.salvar()
